...
namespace INTSOF.Utils.UI
{
    ...
    ///// </summary>
    //public interface IBrowserDetailOutput
    //{
    //    /// <summary>
    ...
    /// a user agent string
    /// </summary>
    //public class ClientInfo : IBrowserDetailOutput
    ...
    public sealed class Parser
    {
        ...
        /// <remarks>The embedded regex definitions may be outdated. Consider passing in external yaml definitions using <see cref="~/Resources/Mod/CommonOperations/BrowserDetails/regexes.yaml"/> or
        /// <see cref="Parser.FromYamlFile"/></remarks>
        /// </summary>
        /// <returns></returns>
        public static Parser GetDefault(string path)
        {
