...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:RoleUpdate" >
    <HTML>
      <BODY>
  ...
  <xsl:template match="mstns:Contents">
    ...
    <p>There is a change in the role assigned to you, your current role(s) is/are:</p>
    <p>
      Role(s):&#160;<xsl:value-of select="mstns:allAssignedRoleName"/>
    </p>
