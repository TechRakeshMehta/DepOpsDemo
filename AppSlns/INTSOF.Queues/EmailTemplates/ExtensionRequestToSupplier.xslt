...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:Contents">
    <p>
      The <xsl:value-of select="mstns:ExtensionCategory"/> Extension Request <xsl:value-of select="mstns:ExtraText"/> <xsl:value-of select="mstns:DecisionText"/>
      for Service Order ID: <xsl:value-of select="mstns:SvcReqId"/>.
    </p>
