...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:VerficationCode" >
    <HTML>
      <BODY>
  ...
  <xsl:template match="mstns:Contents">
    <p>Hello  <xsl:value-of select="mstns:UserName"/>,</p>
    <p>A request has been made to retrieve your <xsl:value-of select="mstns:TenantName"/> account username. To retrieve your username, you need to submit this verification code in order to verify that the request was legitimate.</p>
    <p>Your verification code  is: <xsl:value-of select="mstns:Code"/></p>
    <p>This is an automatically generated message. Replies are not monitored or answered.</p>
      Thanks &amp; Regards<br/>  ADB Admin<br/><br/>
