...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:Contents">
    <p>
      Updated Property Information has been identified for the Asset for Service Request ID:&#160;<xsl:value-of select="mstns:ServiceRequestId"/>
    </p>
    <p>
      You are being informed of this information so that you may take any necessary next steps.  Updated information is listed below:
