...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:Contents">
    ...
    <p>Welcome to ADB!</p>
    <p>Following are your account details for login in to ADB:</p>
    Username:&#160;<xsl:value-of select="mstns:LoweredUserName"/><br/>
    Temporary Password*: <xsl:value-of select="mstns:DefaultPassword"/><br/>
    Role(s):&#160;<xsl:value-of select="mstns:Role"/><br/>
    <p>* You will be prompted to change the Temporary Password after first time login.</p>
