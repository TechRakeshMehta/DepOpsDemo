...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:PasswordReset" >
    <HTML>
      <BODY>
  ...
  <xsl:template match="mstns:Contents">
    <p> Hello  <xsl:value-of select="mstns:FirstName"/>&#160;<xsl:value-of select="mstns:LastName"/>, </p>
    <p>Your password is: <xsl:value-of select="mstns:Password"/></p>
