...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="mstns:Contents">
    ...
    <p>A request has been made to reset your COMPLIO account password. To reset your password, you need to submit this verification code in order to verify that the request was legitimate.</p>
