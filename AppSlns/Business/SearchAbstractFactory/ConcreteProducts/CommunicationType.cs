...
{
    public class CommunicationType<TFactory> : ISearchEntities<Message>, ISearchEntities<NonMessage>
    {
        ...
        {
            return SearchManager.QuickSearch<vwCommunicationType>(Fields, SearchText, orderby, exactmatch); 
        }
