...
namespace INTSOF.AuthNet.Business
{
    ...
    public class Gateway : BaseAuthNetManager, IGateway {
        ...
        public bool TestMode { get; set; } // Dont need this, can use base.IsAuthNetInTestMode directly 
		...
		public virtual IGatewayResponse Send (IGatewayRequest request, string description)
		{
            ...
            var serviceUrl = (TestMode == true?  base.AuthNetTestURL: base.AuthNetLiveURL);
