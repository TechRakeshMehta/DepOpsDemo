...
namespace INTSOF.Utils.PDFConversion {
    ...
    public interface IPDFConversion {
        ...
        INTSOF.Utils.PDFConversion.ApplicantDoc[] ConvertApplicantDocumentToPDF(INTSOF.Utils.PDFConversion.ApplicantDoc[] applicantDocuments, int tenantID, string applicantFileLocation);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/ConvertApplicantDocumentToPDF", ReplyAction="http://tempuri.org/IPDFConversion/ConvertApplicantDocumentToPDFResponse")]
        System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDoc[]> ConvertApplicantDocumentToPDFAsync(INTSOF.Utils.PDFConversion.ApplicantDoc[] applicantDocuments, int tenantID, string applicantFileLocation);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/MergeConvertedDocumentToPDF", ReplyAction="http://tempuri.org/IPDFConversion/MergeConvertedDocumentToPDFResponse")]
        INTSOF.Utils.PDFConversion.ApplicantDocMerging[] MergeConvertedDocumentToPDF(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/MergeConvertedDocumentToPDF", ReplyAction="http://tempuri.org/IPDFConversion/MergeConvertedDocumentToPDFResponse")]
        System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDocMerging[]> MergeConvertedDocumentToPDFAsync(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation);
        ...
        INTSOF.Utils.PDFConversion.ApplicantDocMerging[] AppendConvertedDocumentToPDF(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation, string previousUnifiedPdfPath, int sequenceOrder, int previousPages);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/AppendConvertedDocumentToPDF", ReplyAction="http://tempuri.org/IPDFConversion/AppendConvertedDocumentToPDFResponse")]
        System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDocMerging[]> AppendConvertedDocumentToPDFAsync(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation, string previousUnifiedPdfPath, int sequenceOrder, int previousPages);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/GetPdfPageCountPdfMerge", ReplyAction="http://tempuri.org/IPDFConversion/GetPdfPageCountPdfMergeResponse")]
        int GetPdfPageCountPdfMerge(string filePath);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPDFConversion/GetPdfPageCountPdfMerge", ReplyAction="http://tempuri.org/IPDFConversion/GetPdfPageCountPdfMergeResponse")]
        System.Threading.Tasks.Task<int> GetPdfPageCountPdfMergeAsync(string filePath);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPDFConversionChannel : INTSOF.Utils.PDFConversion.IPDFConversion, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PDFConversionClient : System.ServiceModel.ClientBase<INTSOF.Utils.PDFConversion.IPDFConversion>, INTSOF.Utils.PDFConversion.IPDFConversion {
        ...
        public INTSOF.Utils.PDFConversion.ApplicantDoc[] ConvertApplicantDocumentToPDF(INTSOF.Utils.PDFConversion.ApplicantDoc[] applicantDocuments, int tenantID, string applicantFileLocation) {
            return base.Channel.ConvertApplicantDocumentToPDF(applicantDocuments, tenantID, applicantFileLocation);
        }
        
        public System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDoc[]> ConvertApplicantDocumentToPDFAsync(INTSOF.Utils.PDFConversion.ApplicantDoc[] applicantDocuments, int tenantID, string applicantFileLocation) {
            return base.Channel.ConvertApplicantDocumentToPDFAsync(applicantDocuments, tenantID, applicantFileLocation);
        }
        
        public INTSOF.Utils.PDFConversion.ApplicantDocMerging[] MergeConvertedDocumentToPDF(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation) {
            return base.Channel.MergeConvertedDocumentToPDF(unifiedDocumentID, tenantID, applicantDocuments, applicantFileLocation);
        }
        
        public System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDocMerging[]> MergeConvertedDocumentToPDFAsync(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation) {
            return base.Channel.MergeConvertedDocumentToPDFAsync(unifiedDocumentID, tenantID, applicantDocuments, applicantFileLocation);
        }
        
        public INTSOF.Utils.PDFConversion.ApplicantDocMerging[] AppendConvertedDocumentToPDF(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation, string previousUnifiedPdfPath, int sequenceOrder, int previousPages) {
            return base.Channel.AppendConvertedDocumentToPDF(unifiedDocumentID, tenantID, applicantDocuments, applicantFileLocation, previousUnifiedPdfPath, sequenceOrder, previousPages);
        }
        
        public System.Threading.Tasks.Task<INTSOF.Utils.PDFConversion.ApplicantDocMerging[]> AppendConvertedDocumentToPDFAsync(int unifiedDocumentID, int tenantID, INTSOF.Utils.PDFConversion.ApplicantDocToBeMerged[] applicantDocuments, string applicantFileLocation, string previousUnifiedPdfPath, int sequenceOrder, int previousPages) {
            return base.Channel.AppendConvertedDocumentToPDFAsync(unifiedDocumentID, tenantID, applicantDocuments, applicantFileLocation, previousUnifiedPdfPath, sequenceOrder, previousPages);
        }
        
        public int GetPdfPageCountPdfMerge(string filePath) {
            return base.Channel.GetPdfPageCountPdfMerge(filePath);
        }
        
        public System.Threading.Tasks.Task<int> GetPdfPageCountPdfMergeAsync(string filePath) {
            return base.Channel.GetPdfPageCountPdfMergeAsync(filePath);
        }
    }
}
