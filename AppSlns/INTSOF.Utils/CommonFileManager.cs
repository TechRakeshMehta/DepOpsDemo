...
namespace INTSOF.Utils
{
    public class CommonFileManager
    {
        ...
        /// <returns></returns>
        public static String SaveDocument(String srcFilePath, String destFilePath, String fileType)
        {
            try
            {
                Boolean aWSUseS3 = false;
                String applicantFileLocation = String.Empty;
                String messageFileLocation = String.Empty;
                String systemDocumentLocation = String.Empty;
                String destFileLocation = String.Empty;
                String finalDestFileLocation = String.Empty;
                if (srcFilePath.IsNullOrEmpty() && destFilePath.IsNullOrEmpty())
                {
                    return null;
                }
                ...
                if (!ConfigurationManager.AppSettings["ApplicantFileLocation"].IsNullOrEmpty())
                {
                    applicantFileLocation = ConfigurationManager.AppSettings["ApplicantFileLocation"];
                }
                if (!ConfigurationManager.AppSettings["MessageFileLocation"].IsNullOrEmpty())
                {
                    messageFileLocation = ConfigurationManager.AppSettings["MessageFileLocation"];
                }
                if (!ConfigurationManager.AppSettings[AppConsts.SYSTEM_DOCUMENT_LOCATION].IsNullOrEmpty())
                {
                    systemDocumentLocation = ConfigurationManager.AppSettings[AppConsts.SYSTEM_DOCUMENT_LOCATION];
                }
                ...
                if (aWSUseS3 == false)
                {
                    if (fileType == FileType.ApplicantFileLocation.GetStringValue())
                    {
                        destFileLocation = applicantFileLocation;
                    }
                    else if (fileType == FileType.MessageFileLocation.GetStringValue())
                    {
                        destFileLocation = messageFileLocation;
                    }
                    else if (fileType == FileType.SystemDocumentLocation.GetStringValue())
                    {
                        destFileLocation = systemDocumentLocation;
                    }
                ...
                else //true if Amazon S3 will be used
                {
                    ...
                    if (_AWSDirPathInBucket.IsNullOrEmpty())
                    {
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        public static String SaveDocument(Byte[] srcFileBytes, String destFilePath, String fileType)
        {
            try
            {
                Boolean aWSUseS3 = false;
                ...
                String destFileLocation = String.Empty;
                String finalDestFileLocation = String.Empty;
                if (srcFileBytes.IsNullOrEmpty() && destFilePath.IsNullOrEmpty())
                {
                    return null;
                }
                if (!ConfigurationManager.AppSettings["AWSUseS3"].IsNullOrEmpty())
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        public static byte[] RetrieveDocument(String filePath, String fileType)
        {
            try
            {
        ...
        /// <param name="fileType"></param>
        /// <returns></returns>
        public static Boolean DeleteDocument(String filePath, String fileType)
        {
            try
            {
                Boolean aWSUseS3 = false;
        ...
        public static string GetFilePath(String fileName, String fileType)
        {
            ...
            try
            {
                ...
                if (aWSUseS3 == false)
                {
                    ...
                    if (fileType == FileType.ApplicantFileLocation.GetStringValue())
                    {
                        filePath = applicantFileLocation;
                    }
                    else if (fileType == FileType.MessageFileLocation.GetStringValue())
                    {
                        filePath = messageFileLocation;
                    }
                    else if (fileType == FileType.SystemDocumentLocation.GetStringValue())
                    {
                        filePath = systemDocumentLocation;
                    }
        ...
        /// <summary>
        /// Checks whether file exists on given path or not
        /// </summary>
        /// <param name="filePath"></param>
        /// <returns></returns>
        public static Boolean DoesDocExist(String filePath)
        {
        ...
        public static List<String> GetViewableDocumentExtensions()
        {
            return new List<String>(new String[] { ".pdf", ".png", ".bmp", ".gif", ".jpg", ".jpeg" });
        }
        #endregion
    }
}
