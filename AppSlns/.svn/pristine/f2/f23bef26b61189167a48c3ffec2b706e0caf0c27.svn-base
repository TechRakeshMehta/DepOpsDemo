...
// 
// Filename:  RuleTemplateFormBkg.ascx.cs
// Purpose:   
//
...
{
    public partial class RuleTemplateFormBkg : BaseUserControl, IRuleTemplateFormBkgView
    {
        #region Private Variables

        private RuleTemplateFormBkgPresenter _presenter = new RuleTemplateFormBkgPresenter();
        ...
        public RuleTemplateFormBkgPresenter Presenter
        {
            get
            {
        ...
        /// </summary>
        /// <remarks></remarks>
        IRuleTemplateFormBkgView CurrentViewContext
        {
            get
            {
                return this;
        ...
        public List<lkpBkgExpressionOperator> ExpressionOperators { get; set; }
        ...
        private void RoutePageBack(bool showSuccessMessage, bool isSaveRequest = false)
        {
            ...
            queryString.Add("Child", @"SetupRuleTemplateBkg.ascx");
