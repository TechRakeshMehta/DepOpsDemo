<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.Reports.Views.RotationStudentsByDay"
    CodeBehind="RotationStudentByDay.ascx.cs" EnableTheming="true" %>
...
<div class="container-fluid">
    ...
    <div class='description'>
        ...
        This report lists students in current or previous rotations, with a filter for the specific day(s) of the week the students were on-site.                       
            <ul class="list">
                <li class="listcontent">Can be filtered by institution, agency hierarchy, by the day(s) of the week on which the rotations meet, and by profile review status.</li>
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <infs:WclComboBox ID="cmbDays" Width="100%" CssClass="form-control" runat="server" AllowCustomText="true"
                        AutoPostBack="false" DataTextField="Value" DataValueField="Key" EmptyMessage="--SELECT--"
                        Skin="Silk" AutoSkinMode="false"
                        EnableCheckAllItemsCheckBox="true" CheckBoxes="true" Filter="Contains" CausesValidation="false">
                    </infs:WclComboBox>
                    <div class="vldx">
                        <asp:RequiredFieldValidator runat="server" ID="rfvDays" ControlToValidate="cmbDays" ValidationGroup="btnsubmit"
                            Display="Dynamic" CssClass="errmsg" Text="Day is required." />
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-md-12">
            <div class="row">
                <infs:WclGrid runat="server" ID="grdReportData" AutoGenerateColumns="False"
                    ...
                    <MasterTableView CommandItemDisplay="Top" AllowFilteringByColumn="false" HeaderStyle-CssClass="left">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="SharedBy"
                                HeaderText="School Representative Name" SortExpression="SharedBy"
                                ItemStyle-HorizontalAlign="Left" UniqueName="SharedBy">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="SharedByEmail"
                                HeaderText="School Representative Email" SortExpression="SharedByEmail"
                                ItemStyle-HorizontalAlign="Left" UniqueName="SharedByEmail">
                            </telerik:GridBoundColumn>
