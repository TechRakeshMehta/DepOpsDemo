<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ApplicantRotationRequirement.Views.RequirementRowControl" CodeBehind="RequirementRowControl.ascx.cs" %>
