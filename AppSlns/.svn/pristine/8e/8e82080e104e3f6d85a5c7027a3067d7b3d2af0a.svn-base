<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ApplicantRotationRequirement.Views.RequirementItemForm" CodeBehind="RequirementItemForm.ascx.cs" %>
        ...
        <div class='sxro sx2co'>
            ...
            <div class='sxlm m2spn'>
                <infs:WclAsyncUpload runat="server" ID="fupItemData" ClientName="fupItemDataCName" CssClass="complioFileUpload"
                    ...
                    OnClientValidationFailed="upl_OnClientValidationFailedReq" AllowedFileExtensions="ods,xls,xlsx,csv,png,jpg,jpeg,jpe,bmp,JPG,gif,tif,tiff,docx,doc,rtf,pdf,txt,ODS,XLS,XLSX,CSV,PNG,JPG,JPEG,JPE,BMP,JPG,GIF,TIF,TIFF,DOCX,DOC,RTF,PDF,TXT">
                ...
                <div id="<%=DropzoneID%>" class="dvApplicantDocumentDropzone sxro sx2co mod-content issue-drop-zoneItemForm drgndrop_border_class ">
                    ...
                    <input type="button" id="btnDropZone" class="issue-drop-zone__button" runat="server" value="Browse" onclick="OpenDialog()" />
                        </span>
                    </div>
                </div>
