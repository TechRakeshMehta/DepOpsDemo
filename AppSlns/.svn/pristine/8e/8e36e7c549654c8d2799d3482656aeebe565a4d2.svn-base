<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminEntryApplicantRequiredDocumentation.ascx.cs"
    Inherits="CoreWeb.AdminEntryPortal.Views.AdminEntryApplicantRequiredDocumentation" %>
