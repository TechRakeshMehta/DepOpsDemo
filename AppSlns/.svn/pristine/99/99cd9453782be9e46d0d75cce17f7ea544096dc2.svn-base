...
{
    public partial class NewPreviousAddressControl : BaseUserControl
    {
        ...
        protected void grdResidentialHistory_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                {
                    CoreWeb.CommonControls.Views.NewLocationInfo _locInfo = (e.Item.FindControl("locationTenant") as CoreWeb.CommonControls.Views.NewLocationInfo);
            ...
            try
            {
                if (e.Item is GridEditableItem && e.Item.IsInEditMode)
                {
                    ...
                    else
                    {
                        ...
                        {
                            CoreWeb.CommonControls.Views.NewLocationInfo _locInfo = (editform.FindControl("locationTenant") as CoreWeb.CommonControls.Views.NewLocationInfo);
        ...
        protected void grdResidentialHistory_ItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                if ((e.Item is GridEditFormItem) && (e.Item.IsInEditMode))
                {    //UAT-1955
                    hdnControlToSetFocus.Value = "lblEHPrevAddress";
                }
            }
            catch (SysXException ex)
            {
