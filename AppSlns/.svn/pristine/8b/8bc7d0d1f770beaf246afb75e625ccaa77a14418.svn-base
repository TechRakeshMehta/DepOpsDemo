<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PopupMaster.master" AutoEventWireup="true" CodeBehind="ViewDocumentPopup.aspx.cs" Inherits="CoreWeb.ApplicantRotationRequirement.Pages.ViewDocument" %>
    ...
    <div class="section">
        ...
        Disclaimer / Limitation of Liability</h1>--%>
                ...
                <div style="float: right; padding-top: 5px;">
                    <%--<asp:Button ID="btnSavePdf" runat="server" Text="Save" OnClientClick="return PdfSave();" OnClick="btnSavePdf_Click"/>--%>
                    <%--<asp:Button ID="btnSavePdf" runat="server" Text="Save" OnClick="btnSavePdf_Click"/>--%>
                    <infs:WclButton ID="btnSavePdf" Text="Save" OnClientClicked="btnSavePdfClick" OnClick="btnSavePdf_Click" runat="server"></infs:WclButton>
                    ...
                    <%--<infs:WclButton ID="btnCancel" Text="Close" OnClientClicked="btnSavePdfClick" OnClick="btnCancel_Click" runat="server"></infs:WclButton>--%>
                </div>
            </div>
        </div>
