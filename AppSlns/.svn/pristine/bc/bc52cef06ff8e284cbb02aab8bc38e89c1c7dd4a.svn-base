<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDataEntryDocViewer.aspx.cs" Inherits="CoreWeb.ComplianceOperations.AdminDataEntryDocViewer" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/Resources/Mod/ComplianceOperations/AdminDataEntryDocViewer.js" />
            </Scripts>
        </asp:ScriptManager>
        <div class="toolbox">
