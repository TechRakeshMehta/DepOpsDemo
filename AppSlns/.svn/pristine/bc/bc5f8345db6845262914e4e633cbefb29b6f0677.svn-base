...
{
    public partial class ApplicantDisclosure : BaseUserControl, IApplicantDisclosureView
    {
        #region VARIABLES
        ...
        private ApplicantDisclosurePresenter _presenter = new ApplicantDisclosurePresenter();
        ...
        public ApplicantDisclosurePresenter Presenter
        {
            get
            {
        ...
        public IApplicantDisclosureView CurrentViewContext
        {
            get
            {
                return this;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                // aViewForm.HRef = SysXWebSiteUtils.SessionService.GetCustomData("CURRENT_URL").ToString();
            }
        ...
        protected void fsucCmdBar1_SubmitClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!hiddenOutput.Value.IsNullOrEmpty() && chkAccept.Checked)
                {
                    ...
                    //    Session["retainFields"] = "true";
                    //    //hiddenOutput.Value = "Short";
                    //    //hdnShortSignature.Value = "true";
                    //    return;
                    //}
                    ...
                    if (fsucCmdBar1.ClearButton.Value == AppConsts.PROCEED_BUTTON_TEXT || fsucCmdBar1.ClearButton.Value == AppConsts.NEXT_BUTTON_TEXT)
                    {
                        ...
                        if (applicantOrderCart != null)
                        {
                            ...
                            //UAT-2862: Redirect to Disclaimer Page when applicant select only Screening package(s) as well.
                            //if (!applicantOrderCart.IsCompliancePackageSelected)
                            //{
                    ...
                    SetButtonText();
                    //fsucCmdBar1.ClearButton.Text = "Proceed";
                    //fsucCmdBar1.ClearButton.Value = "Proceed";
        ...
        protected void fsucCmdBar1_ExtraClick(object sender, EventArgs e)
        {
            ...
            if (CurrentViewContext.OrderType == OrderRequestType.NewOrder.GetStringValue())
            {
                ...
                else
                {
                    ...
                    Response.Redirect(String.Format("~/ComplianceOperations/Default.aspx?args={0}", queryString.ToEncryptedQueryString())); //UAT - 5184
                }
                // }
                #endregion
            }
        ...
        private void LoadDisclosureDocument()
        {
            ...
            if (SystemDocumentID > 0 && SystemDocumentIsDeleted == false)
            {
                ...
                //lnkbtnViewDisclosureForm.Visible = true;
            ...
            try
            {
                ...
                if (documentInfo.DocumentPath != null)
                {
                    ...
                    try
                    {
                        ...
                        //if (aWSUseS3 == false)
                        //{
                        //    if (File.Exists(documentInfo.DocumentPath))
                        //    {
                        //        _fileStream = new FileStream(documentInfo.DocumentPath, System.IO.FileMode.Open, System.IO.FileAccess.Read);
                        //        _totalBytes = new System.IO.FileInfo(documentInfo.DocumentPath).Length;
                        //        BinaryReader _binaryReader = new BinaryReader(_fileStream);
                        //        //read entire file into buffer
                        //        buffer = _binaryReader.ReadBytes((Int32)_totalBytes);
                        //        _fileStream.Close();
                        ...
                        //    else
                        //    {
                        //        base.LogInfo("File not found" + documentInfo.DocumentPath);
                        //        lblMessage.Text = "No disclosure form to display";
                        //        lnkbtnViewDisclosureForm.Visible = false;
                        //        return false;
                        //    }
                        ...
                        //{
                        //    AmazonS3Documents objAmazonS3Documents = new AmazonS3Documents();
                        //    byte[] documentContent = objAmazonS3Documents.RetrieveDocument(documentInfo.DocumentPath);
        ...
        private Boolean UpdateDisclosurerPdfWithEsignature(byte[] pdfBytes, Boolean aWSUseS3, SysDocumentFieldMappingContract documentInfo, byte[] bufferSignature)
        {
            ...
            try
            {
                ...
                String newFinalFilePath = String.Empty;
                //filename = "Disclosure Form" + "_" + "Package" + "_" + date;
                ...
                try
                {
                    ...
                    //{
                    //    if (File.Exists(documentInfo.DocumentPath))
                    //        File.Delete(documentInfo.DocumentPath);
                    //    //Move file to other location
                    //    File.Copy(newTempFilePath, documentInfo.DocumentPath);
                    //    newFinalFilePath = documentInfo.DocumentPath;
                    ...
                    //    //AWS code to save document to S3 location
                    //    AmazonS3Documents objAmazonS3 = new AmazonS3Documents();
                    //    Presenter.DeleteFileAmazonS3(documentInfo.DocumentPath);
                    //    String destFolder = "Tenant(" + TenantID.ToString() + @")/";
                    //    objAmazonS3.SaveDocument(newTempFilePath, newFileName, destFolder);
                    //    newFinalFilePath = Path.Combine(destFolder, newFileName);
                    //}
