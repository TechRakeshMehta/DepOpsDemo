...
namespace Resources {
    ...
    internal class GlobalResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to IComply 2.161.0.1468 11062018.
        /// </summary>
        internal static string SysXWebAppVersion {
            get {
                return ResourceManager.GetString("SysXWebAppVersion", resourceCulture);
            }
        }
    }
}
