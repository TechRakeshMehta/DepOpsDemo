<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminEntryApplicantDisclosure.ascx.cs" Inherits="CoreWeb.AdminEntryPortal.Views.AdminEntryApplicantDisclosure" %>
