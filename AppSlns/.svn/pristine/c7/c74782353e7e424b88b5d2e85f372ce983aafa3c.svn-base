...
{
    public partial class VerificationUserQueue : System.Web.UI.UserControl, IVerificationUserQueueView
    {
        #region Privare Variables

        private VerificationUserQueuePresenter _presenter = new VerificationUserQueuePresenter();
        ...
        public VerificationUserQueuePresenter Presenter
        {
            get
            {
        ...
        /// <summary>
        /// Page_Load event
        /// Redirect to UserItemsDataQueue.ascx page
        /// </summary>
        ...
        public void GetUrl()
        {
            ...
            Dictionary<String, String> queryString = new Dictionary<String, String>
                                                                 { 
                                                                    ...
                                                                    { "Child",@"~\ComplianceOperations\UserItemsDataQueue.ascx"},
                                                                    { "QCODE", queueCode}
                                                                 };
