<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ComplianceOperations.Views.TrackingDataUpdateHistory" CodeBehind="TrackingDataUpdateHistory.ascx.cs" %>
...
<div class="section">
    <h1 class="mhdr">Tracking Data Update History</h1>
    <div class="content">
            ...
            <infs:WclGrid runat="server" ID="grdApplicantDataAudit" AutoGenerateColumns="False"
                ...
                <MasterTableView AllowFilteringByColumn="false" CommandItemDisplay="Top" DataKeyNames="ApplicantDataAuditID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="ChangeBYInitials" FilterControlAltText="Filter ChangeBy column"
