...
namespace CoreWeb.BkgOperations.Views
{
    ...
    public partial class WebCCF : BaseUserControl, IWebCCFView
    {
        ...
        private WebCCFPresenter _presenter = new WebCCFPresenter();
        ...
        public WebCCFPresenter Presenter
        {
            get
            {
        ...
        String IWebCCFView.StateAbbreviation
        {
            get;
            set;
        }

        String IWebCCFView.ZipCode
        {
            get;
            set;
        }

        List<Int32> IWebCCFView.BackgroundPackageIdList
        {
            get;
            set;
        }

        String IWebCCFView.ClearStarServiceId
        {
            get;
            set;
        }
        ...
        List<Int32> IWebCCFView.BPHMIds
        {
            get;
            set;
        }

        String IWebCCFView.ExtVendorAccountNumber
        {
            get;
            set;
        }

        String IWebCCFView.IsUSCitizen
        {
            get;
            set;
        }
        ...
        Int32 IWebCCFView.SelectedNodeId
        {
            get
            {
        ...
        private IWebCCFView CurrentViewContext
        {
            get { return this; }
        }
        #endregion
        ...
        private void SetRequiredWebCCFVariables()
        {
            ...
            if (!applicantOrderCart.IsNullOrEmpty())
            {
                ...
                //Clearstar Test Value
                //hidBOID.Value = "445";
                //ADB Test Customer ID
                //hidCustID.Value = "AMER_02772";
                hdnCustomerID.Value = CurrentViewContext.ExtVendorAccountNumber;//TODO eva.AccountNumber;
                //Clearstar Test Customer Value
                //hidCustID.Value = "LOGI_00013";
                ...
                //ADB e Drugscreen ID
                //hdnTest.Value = "AMER_00469";
                hdnTest.Value = CurrentViewContext.ClearStarServiceId;
                //Clearstar e Drugscreen ID
                //hdnTest.Value = "LOGI_00125";
                //hdnLab.Value = 
                hdnReason.Value = "P";
        ...
        protected void cmdbarEdit_Click(object sender, EventArgs e)
        {
            ...
            //Response.Redirect(String.Format("~/BkgOperations/Pages/CustomFormPage.aspx?SelectedTenantId=" + Convert.ToString(CurrentViewContext.TenantId) + "&IsAdminEditMode=false&IsNewCustomForm=false&CustomFormId=" + Convert.ToString(CustomFormId) + "&IsPrevious=1"));
            String url = "BkgOperations/Pages/CustomFormPage.aspx?SelectedTenantId=" + Convert.ToString(CurrentViewContext.TenantId) + "&IsAdminEditMode=false&IsNewCustomForm=false&CustomFormId=" + Convert.ToString(CustomFormId) + "&IsPrevious=1";
