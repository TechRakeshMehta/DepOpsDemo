<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ComplianceOperations.Views.StudentClientAdminDataAuditHistory" CodeBehind="StudentClientAdminDataAuditHistory.ascx.cs" %>
...
<div class="section">
    <h1 class="mhdr">Student and Admin Data Audit History</h1>
    <div class="content">
                    ...
                    <div class='sxro sx3co'>
                        ...
                        <div class='sxlm'>
                            <infs:WclComboBox ID="ddlPackage" runat="server" EmptyMessage="--Select--" AutoPostBack="false" DataTextField="PackageName" Filter="Contains" EnableCheckAllItemsCheckBox="true"
                                CheckBoxes="true" OnClientKeyPressing="openCmbBoxOnTab"  OnClientDropDownClosed="OnPackageClosed"
                        ...
                        <div class='sxlm'>
                            <infs:WclComboBox ID="ddlCategory" runat="server" EmptyMessage="--Select--" AutoPostBack="false" CheckBoxes="true"
