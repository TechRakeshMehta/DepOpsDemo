...
{
    public partial class SharedUserRequirementRowControl : BaseUserControl, IRequirementRowControlView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SharedUserRequirementAttributeControl attributeControl = (SharedUserRequirementAttributeControl)Page.LoadControl("~\\ApplicantRotationRequirement\\UserControl\\SharedUserRequirementAttributeControl.ascx");
