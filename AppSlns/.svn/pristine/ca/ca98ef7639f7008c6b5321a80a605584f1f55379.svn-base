<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomFormLoad.ascx.cs" Inherits="CoreWeb.BkgOperations.Views.CustomFormLoad" %>
<%@ Register TagPrefix="infsu" TagName="CommandBar" Src="~/Shared/Controls/CommandBar.ascx" %>
<%@ Register Src="CustomFormHtlm.ascx" TagName="CustomFormHtlm" TagPrefix="uc1" %>
