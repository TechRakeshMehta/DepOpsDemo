<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RequirementVerificationReadOnlyCategoryControl.ascx.cs"
    Inherits="CoreWeb.ClinicalRotation.Views.RequirementVerificationReadOnlyCategoryControl" %>
        ...
        <div class="col-md-12">
            <div class="col-md-6">
                <div class="row h2text">
                    <asp:Image ID="imgCatStatus" runat="server" CssClass="statusImg" />
...
<script type="text/javascript">
    ...
    function ShowHideNotes(sender) {
        $jQuery(sender).parents('.section').find('span').toggleClass('help_on');
        $jQuery(sender).parents('.section').find('.showHideContent').toggle('slow');
    }
