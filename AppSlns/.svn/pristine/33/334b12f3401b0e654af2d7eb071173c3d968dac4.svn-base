<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DrugScreenDataControl.ascx.cs" Inherits="CoreWeb.BkgOperations.Views.DrugScreenDataControl" %>
<%@ Register TagPrefix="uc" TagName="WebCCF" Src="~/BkgOperations/UserControl/WebCCF.ascx" %>
