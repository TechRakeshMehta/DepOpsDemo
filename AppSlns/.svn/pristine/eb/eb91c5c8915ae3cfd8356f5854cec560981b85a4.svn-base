...
{
    public partial class ViewVideoPopup : BaseWebPage, IViewVideoPopupView
    {

        #region Variables

        #region Private Variables
        private ViewVideoPopupPresenter _presenter = new ViewVideoPopupPresenter();
        ...
        RequirementPackageContract IViewVideoPopupView.RequirementPackageContractSessionData
        {
            get
            {
        ...
        String IViewVideoPopupView.VideoPreviewURL
        {
            get;
            set;
        }

        Int32 IViewVideoPopupView.RequrmntFieldVideoID
        {
            get;
            set;
        }

        Int32 IViewVideoPopupView.TenantID
        {
            get;
            set;
        }

        Int32 IViewVideoPopupView.RequrmntObjTreeID
        {
            get;
            set;
        }

        RequirementFieldVideoData IViewVideoPopupView.RequrmntVideoData
        {
            get;
            set;
        }

        ObjectAttributeContract IViewVideoPopupView.ObjectAttrContract
        {
            get;
            set;
        }

        RequirementObjectTreeContract IViewVideoPopupView.RequrmntObjTreePropertyContract
        {
            get;
            set;
        }

        String IViewVideoPopupView.IsFromAdmin
        {
            get;
            set;
        }

        Boolean IViewVideoPopupView.IsEditMode
        {
            get;
            set;
        }
        ...
        public ViewVideoPopupPresenter Presenter
        {
            get
            {
        ...
        public IViewVideoPopupView CurrentViewContext
        {
            get { return this; }
        }
        ...
        private void SetVideoWndControls()
        {
            ...
            //iframeViewVideo.Src = CurrentViewContext.RequrmntVideoData.VideoURL;
