<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.Reports.Views.ItemDataCountReport"
    CodeBehind="ItemDataCountReport.ascx.cs" EnableTheming="true" %>
...
<div class="container-fluid">
    ...
    <div class='description'>
        ...
        This report provides a count of how many submissions there have been for selected compliance items.                       
            <ul class="list">
                <li class="listcontent">Can be filtered by institution, agency hierarchy, and submission dates.</li>
        ...
        <div class="col-md-12">
            <div class="row">
                <infs:WclGrid runat="server" ID="grdReportData" AutoGenerateColumns="False"
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="TenantName, ItemName, PackageType" AllowFilteringByColumn="false">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="PackageType"
                                HeaderText="Package Type" SortExpression="PackageType" UniqueName="PackageType" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ItemCount"
                                HeaderText="Item Count" SortExpression="ItemCount" UniqueName="ItemCount" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                        </Columns>
