<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ComplianceAdministration.Views.CustomAttributeControlSearch" Codebehind="CustomAttributeControlSearch.ascx.cs" %>
