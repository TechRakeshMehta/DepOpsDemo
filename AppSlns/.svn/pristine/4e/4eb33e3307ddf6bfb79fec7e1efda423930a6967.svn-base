...
{
    public partial class RotationStudentsNonComplianceStatus : BaseUserControl, IRotationStudentsNonComplianceStatusView
    {
        SysXMembershipUser _user;
        String _userID = String.Empty;
        private RotationStudentsNonComplianceStatusPresenter _presenter = new RotationStudentsNonComplianceStatusPresenter();
        private Boolean IsSharedUserLoginURL;

        public RotationStudentsNonComplianceStatusPresenter Presenter
        {
            get
            {
        ...
        public IRotationStudentsNonComplianceStatusView CurrentViewContext
        {
            get
            {
                return this;
        ...
        public Boolean IncludeUndefinedDataShares
        {
            get
            {
                return Convert.ToBoolean(rblIncludeUndefined.SelectedValue);
            }
            set
            {
                rblIncludeUndefined.SelectedValue = value.ToString();
            }
        }
        ...
        {
            base.OnInit(e);
            base.Title = "Rotation Students Non Compliance Status";
            base.SetPageTitle("Rotation Students Non Compliance Status");
        }
        ...
        {
            grdReportData.DataSource = Presenter.GetRotationStudentNonComplianceStatusContracts();
        }
    }
}