...
{
    public partial class SharedUserRequirementAttributeControl : BaseUserControl, IRequirementAttributeControlView
    {
        #region Variables
        ...
        public Boolean IsSharedUserLoggedIn
        {
            get
            {
        ...
        private void CreateDynamicControl(RequirementFieldContract requirementField)
        {
            ...
            if (dataTypeCode == RequirementFieldDataType.DATE.GetStringValue().ToLower().Trim())
            {
                ...
                //UAT-4589 : Start
                if (requirementField.AttributeTypeCode.Equals(AppConsts.REQUIREMENT_FIELD_ATTRIBUTE_TYPE_CALCULATED_CODE))
                    dPicker.DateInput.BackColor = System.Drawing.Color.Transparent;
                //UAT-4589 : End
            ...
            else if (dataTypeCode == RequirementFieldDataType.OPTIONS.GetStringValue().ToLower().Trim())
            {
                ...
                cmbOptions.Skin = "Silk";
                cmbOptions.AutoSkinMode = false;
                cmbOptions.CssClass = "form-control";
                cmbOptions.Width = new Unit("100%");
            ...
            else if (dataTypeCode == RequirementFieldDataType.UPLOAD_DOCUMENT.GetStringValue().ToLower().Trim())
            {
                ...
                //Start UAT-5062
                List<Int32> lstDisableViewDocumentIDs = new List<Int32>();
                //End UAT-5062
                ...
                try
                {
                    if (CurrentViewContext.ApplicantFieldData.IsNotNull() && CurrentViewContext.ApplicantFieldData.LstApplicantFieldDocumentMapping.IsNotNull())
                    {
                        ...
                        //Start UAT-5062
                        lstDisableViewDocumentIDs = CurrentViewContext.ApplicantFieldData.LstApplicantFieldDocumentMapping
                    ...
                    foreach (var document in CurrentViewContext.ApplicantDocuments)
                    {
                        ...
                        //Start UAT-5062
                        if (!lstDisableViewDocumentIDs.IsNullOrEmpty() && lstDisableViewDocumentIDs.Count > AppConsts.NONE
                                && lstDisableViewDocumentIDs.Contains(document.ApplicantDocumentId))
                        {
                            _isEnabled = false;
                        }
                        //End UAT-5062
                ...
                cmbFileUpload.Skin = "Silk";
                cmbFileUpload.AutoSkinMode = false;
                //Start UAT-5062
                cmbFileUpload.CssClass = "form-control cmbFileUpload";
                //cmbFileUpload.CssClass = "form-control";
                //End UAT-5062
                cmbFileUpload.Width = new Unit("100%");
            ...
            else if (dataTypeCode == RequirementFieldDataType.SIGNATURE.GetStringValue().ToLower().Trim())
            {
                ...
                mainDiv.Attributes.Add("style", "width:50% !important;");
