<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.Messaging.Views.CommunicationArchiveSummary" CodeBehind="CommunicationArchiveSummary.ascx.cs" %>
...
<div class="section">
    ...
    <h1 class="mhdr">Communication Archive
    </h1>
    <div class="content">
