...
{
    public partial class CommunicationSummary : BaseUserControl, ICommunicationSummaryView
    {
        #region Variables

        #region Private Variables

        private CommunicationSummaryPresenter _presenter = new CommunicationSummaryPresenter();
        ...
        public ICommunicationSummaryView CurrentViewContext
        {
            get
            {
                return this;
        ...
        public CommunicationSummaryPresenter Presenter
        {
            get
            {
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                base.OnInit(e);
                base.Title = "Communication History";
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            base.SetPageTitle("Communication History");
        }
        ...
        protected void grdCommunicationSummary_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                Presenter.GetCommunicationSummary();
