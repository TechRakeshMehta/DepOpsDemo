<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommonLogin.ascx.cs" Inherits="CoreWeb.Shell.Views.CommonLogin" %>
    ...
    <tr>
        <td>
            <div class="content">
                ...
                <div class="orgname_bl">
                    <asp:Label Text="" runat="server" ID="lblInstituteName" />
                </div>
                <div class="form_bl">
                    <div class="errors">
                ...
                <div class="register" id="dvCreateAccount" runat="server" visible="false">
                    ...
                    <div style="text-align: center; position: relative;">
                        ...
                        <%--title="Click here to watch create account help video." --%>
                        <div id="imgBtnVideo" runat="server" onclick="openRadWin()"></div>
                    </div>
                ...
                <div class="address">
                    <strong>American DataBank Group</strong>, Copyright ©<%=CopyRightYear %>. All Rights Reserved
                            <br />
...
<infs:WclWindowManager ID="WclWindowManager2" runat="server" EnableShadow="true">
    <Windows>
        <infs:WclWindow ID="WclWindow1" Skin="Web20" runat="server" ShowContentDuringLoad="false" Width="400px"
            Height="400px" Title="Video" Behaviors="Default" VisibleOnPageLoad="false" VisibleStatusbar="false">
        </infs:WclWindow>
    </Windows>
</infs:WclWindowManager>
