...
{
    public partial class VerificationAssignmentQueue : System.Web.UI.UserControl, IVerificationAssignmentQueueView
    {
        #region Privare Variables

        private VerificationAssignmentQueuePresenter _presenter = new VerificationAssignmentQueuePresenter();
        ...
        public VerificationAssignmentQueuePresenter Presenter
        {
            get
            {
        ...
        /// <summary>
        /// Page_Load event
        /// Redirect to ItemsDataVerificationQueue.ascx page
        /// </summary>
        ...
        public void GetUrl()
        {
            ...
            Dictionary<String, String> queryString = new Dictionary<String, String>
                                                                 { 
                                                                    ...
                                                                    { "Child",@"~\ComplianceOperations\ItemsDataVerificationQueue.ascx"},
                                                                    { "QCODE", queueCode}
                                                                 };
