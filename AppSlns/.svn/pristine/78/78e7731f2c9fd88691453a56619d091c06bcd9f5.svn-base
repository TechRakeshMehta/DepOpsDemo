<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.Reports.Views.CategoryDataReportByComplioID"
    CodeBehind="CategoryDataReportByComplioID.ascx.cs" EnableTheming="true" %>
    ...
    <div class='description'>
        ...
        This report compiles compliance data from student profiles, broken down by individual items and categories.                       
            <ul class="list">
                ...
                <li class="listcontent">Can be filtered by institution, by agency hierarchy, by rotation dates, by category, by item, by Complio ID, by SEL/Consortium Number, and by profile review status.</li>
    ...
    <div class="row bgLightGreen">
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <span class="cptn">SEL/Consortium Value</span>
                    <infs:WclTextBox ID="txtCustomAttribute" Width="100%" CssClass="form-control" runat="server">
                    </infs:WclTextBox>
                </div>
            </div>
        </div>
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="ID" AllowFilteringByColumn="false">
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="TenantName"
                                ...
                                UniqueName="TenantName" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="LastName"
                                HeaderText="Last Name" SortExpression="LastName"
                                UniqueName="LastName" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="FirstName"
                                HeaderText="First Name" SortExpression="FirstName" 
                                UniqueName="FirstName" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="CategoryName"
                                HeaderText="Category Name" SortExpression="CategoryName"
                                UniqueName="CategoryName" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="CategoryComplianceStatus" SortExpression="CategoryComplianceStatus" HeaderText="Category Compliance Status"
                            ...
                            <telerik:GridBoundColumn DataField="FieldName"
                                HeaderText="Attribute Name" SortExpression="FieldName" UniqueName="FieldName" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="FieldData"
                                HeaderText="Attribute Data" SortExpression="FieldData" UniqueName="FieldData" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="ComplioID"
                                HeaderText="Complio ID" SortExpression="ComplioID" UniqueName="ComplioID" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="CustomAttribute"
                                HeaderText="SEL/Consortium Value" SortExpression="CustomAttribute" UniqueName="CustomAttribute" ItemStyle-HorizontalAlign="Left">
                            </telerik:GridBoundColumn>
