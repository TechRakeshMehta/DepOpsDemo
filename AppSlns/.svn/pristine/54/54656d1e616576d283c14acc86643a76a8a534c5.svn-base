<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RuleTemplateFormBkg.ascx.cs" Inherits="CoreWeb.BkgSetup.Views.RuleTemplateFormBkg" %>
        ...
        <div class="sxform auto">
            <asp:Panel CssClass="sxpnl" runat="server" ID="pnlRuleForm">
                <div class='sxro sx4co'>
                    ...
                    <div class='sxlm'>
                        <infs:WclDropDownList ID="ddlResultType" runat="server" DataTextField="BRSL_Description"
                            DataValueField="BRSL_ID">
                        ...
                        <telerik:GridTemplateColumn DataField="EX_Expression" AllowFiltering="false" HeaderText="Expression"
                            ...
                            <ItemTemplate>
                                <asp:Repeater runat="server" ID="repeatExprElements" OnItemDataBound="repeatExprElements_ItemDataBound">
                                    <ItemTemplate>
                                        <infs:WclDropDownList runat="server" ID="ddlEprOperators" DataTextField="BEO_UILabel"
                                            DataValueField="BEO_SQL" Width="100px" DropDownHeight="100px" DropDownWidth="110px">
                                        </infs:WclDropDownList>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ItemTemplate>
