<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CoreWeb.ComplianceAdministration.Views.UploadAttributeDocuments" CodeBehind="UploadAttributeDocuments.ascx.cs" %>
    ...
    <div class="content">
        <div class="sxform auto">
            <div class='sxro sx3co'>
                <div class='sxlb'>
                    <span class="cptn">Upload Attribute Document(s)</span>
                </div>
...
<infs:WclButton ID="btnUploadAll" runat="server" Text="Upload All" ValidationGroup="grpFormSubmit" OnClick="btnUploadAll_Click" />
