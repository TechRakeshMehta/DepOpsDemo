...
{
    public partial class RotationStudentDetailsReport : BaseUserControl, IRotationStudentDetailsView
    {
        SysXMembershipUser _user;
        String _userID = String.Empty;
        private RotationStudentDetailsPresenter _presenter = new RotationStudentDetailsPresenter();
        private Boolean IsSharedUserLoginURL;

        public RotationStudentDetailsPresenter Presenter
        {
            get
            {
        ...
        public IRotationStudentDetailsView CurrentViewContext
        {
            get
            {
                return this;
        ...
        {
            base.OnInit(e);
            base.Title = "Rotation Student Details Report";
            base.SetPageTitle("Rotation Student Details Report");
        }
        ...
        {
            grdReportData.DataSource = Presenter.GetRotationStudentDetailsContract();
        }
    }
}