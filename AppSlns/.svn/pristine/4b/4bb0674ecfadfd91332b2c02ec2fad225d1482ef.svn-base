<%@ Page Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ComplianceAdministration.Views.PackageCopy"
    Title="PackageCopy" MasterPageFile="~/Shared/ChildPage.master" Codebehind="PackageCopy.aspx.cs" %>
                            ...
                            <div class='sxlm m2spn'>
                                ...
                                <div class="vldx">
                                    <asp:RequiredFieldValidator runat="server" ID="rfvOrganization" ControlToValidate="cmbOrganization"
                                        InitialValue="--SELECT--" Display="Dynamic" CssClass="errmsg" Text="Organization is required." ValidationGroup="grpFormSubmit" />
                                </div>
                            </div>
                            <div class='sxroend'>
                            </div>
