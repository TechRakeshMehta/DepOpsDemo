...
namespace ExternalVendors.xsds.QuestDiagnostics
{
    ...
    public partial class ReceiveCollectionResults
    {

        private string updateStatusField;

        private ReceiveCollectionResultsErrorSummary[] errorSummaryField;
        ...
        public ReceiveCollectionResultsErrorSummary[] ErrorSummary
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class ReceiveCollectionResultsErrorSummary
    {
