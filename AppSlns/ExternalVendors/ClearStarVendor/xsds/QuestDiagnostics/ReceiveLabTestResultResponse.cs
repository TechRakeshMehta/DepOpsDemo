...
namespace ExternalVendors.xsds.QuestDiagnostics
{
    ...
    public partial class ReceivedLabTestResultResults
    {

        private string updateStatusField;

        private ReceivedLabTestResultResultsErrorSummary[] errorSummaryField;
        ...
        public ReceivedLabTestResultResultsErrorSummary[] ErrorSummary
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class ReceivedLabTestResultResultsErrorSummary
    {
