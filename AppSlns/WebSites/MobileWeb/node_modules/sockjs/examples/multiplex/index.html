<!doctype html>
<html><head>
    <script nonce="2726c7f26c" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
    <script nonce="2726c7f26c" src="http://cdn.jsdelivr.net/sockjs/1.0.1/sockjs.min.js"></script>
    <script nonce="2726c7f26c" src="http://cdn.sockjs.org/websocket-multiplex-0.1.js"></script>
    <style>
      .box {
          width: 300px;
          float: left;
