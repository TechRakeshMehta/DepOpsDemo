...
{
    public partial class CategoryDataReport : BaseUserControl, ICategoryDataReportView
    {
        SysXMembershipUser _user;
        String _userID = String.Empty;
        private CategoryDataReportPresenter _presenter = new CategoryDataReportPresenter();
        private Boolean IsSharedUserLoginURL;

        public CategoryDataReportPresenter Presenter
        {
            get
            {
        ...
        public ICategoryDataReportView CurrentViewContext
        {
            get
            {
                return this;
        ...
        public Dictionary<Int32, String> Tenants
        {
            set
            {
                cmbInstitute.DataSource = value.OrderBy(x => x.Key); cmbInstitute.DataBind();
            }
        }
        ...
        {
            base.OnInit(e);
            base.Title = "Category Data Report";
            base.SetPageTitle("Category Data Report");
        }
        ...
        {
            grdReportData.DataSource = Presenter.GetCategoryDataReportContracts();
        }
    }
}