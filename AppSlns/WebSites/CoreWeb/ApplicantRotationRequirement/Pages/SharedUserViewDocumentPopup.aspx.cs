...
{
    public partial class SharedUserViewDocumentPopup : BaseWebPage, IViewDocumentView
    {
        ...
        INTSOF.UI.Contract.ComplianceOperation.AddressContract IViewDocumentView.Addresses { get; set; }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    Presenter.GetClientContactData();
                    GetDocumentToLoad();
        ...
        private void SetFiedsValuesAndPutSignPad()
        {
            ...
            if (pdfData.IsNotNull())
            {
                ...
                {
                    af.SetFieldProperty("FName", "setfflags", PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("MName").IsNotNull())
                {
                    af.SetFieldProperty("MName", "setfflags", PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("LName").IsNotNull())
                {
                    af.SetFieldProperty("LName", "setfflags", PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("FullSSN").IsNotNull())
                {
                    af.SetFieldProperty("FullSSN","setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("DOB").IsNotNull())
                {
                    af.SetFieldProperty("DOB", "setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("PhoneNumber").IsNotNull())
                {
                    af.SetField("PhoneNumber", CurrentViewContext.OrganizationUserData.PhoneNumber);
                    af.SetFieldProperty("PhoneNumber","setfflags", PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("EmailAddress").IsNotNull())
                {
                    ...
                    af.SetFieldProperty("EmailAddress", "setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("Gender").IsNotNull())
                {                   
                    af.SetFieldProperty("Gender", "setfflags",PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("aliasName").IsNotNull())
                {                 
                    af.SetFieldProperty("aliasName", "setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("Address1").IsNotNull())
                {                    
                    af.SetFieldProperty("Address1","setfflags",PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("Address2").IsNotNull())
                {
                    af.SetFieldProperty("Address2","setfflags",PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("City").IsNotNull())
                {                  
                    af.SetFieldProperty("City", "setfflags",PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("State").IsNotNull())
                {                   
                    af.SetFieldProperty("State","setfflags", PdfFormField.FF_READ_ONLY, null);
                }
                if (af.GetField("PostalCode").IsNotNull())
                {                 
                    af.SetFieldProperty("PostalCode", "setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("County").IsNotNull())
                {                 
                    af.SetFieldProperty("County", "setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("Country").IsNotNull())
                {                 
                    af.SetFieldProperty("Country","setfflags",PdfFormField.FF_READ_ONLY, null);

                }
                if (af.GetField("InstitutionName").IsNotNull())
                {                 
                    af.SetFieldProperty("InstitutionName","setfflags", PdfFormField.FF_READ_ONLY,null);
                }
                if (af.GetField("LastFourDigitofSSN").IsNotNull())
                {                 
                    af.SetFieldProperty("LastFourDigitofSSN","setfflags",PdfFormField.FF_READ_ONLY,null);
                }
