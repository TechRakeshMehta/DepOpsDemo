...
function ViewDocument(clientSysDocId, reqFieldId, reqObjectTreeId, reqItemFieldId, applicantDocId) {
    ...
    var url = $page.url.create("~/ApplicantRotationRequirement/Pages/ViewDocumentPopup.aspx?ClientSysDocID=" + clientSysDocId + "&ReqFieldID=" + reqFieldId + "&TenantID=" + TenantID + "&ReqObjectTreeID=" + ReqObjectTreeId + "&ApplicantDocID=" + applicantDocId + "&OrganizationUserId=" + OrganizationUserId);
...
function ViewVideo(reqFieldVideoId, reqObjectTreeId, reqItemFieldId) {
    ...
    var url = $page.url.create("~/ApplicantRotationRequirement/Pages/ViewVideoPopup.aspx?RequrmntFieldVideoID=" + reqFieldVideoId + "&TenantID=" + tenantID + "&RequrmntObjTreeID=" + _reqObjectTreeId + "&IsEditMode=" + isEditMode);
...
function SetViewDocPropertiesOnClose(oWnd, args) {
    ...
    if (arg) {
        ...
        if (arg.Action == "Submit") {
            ...
            //__doPostBack("<%= btnSaveNotes.ClientID %>", "");
...
function ValidateLength(source, args) {
    var noteText = $jQuery("[id$='txtNotes']").val();
    var maxLength = 1000;
