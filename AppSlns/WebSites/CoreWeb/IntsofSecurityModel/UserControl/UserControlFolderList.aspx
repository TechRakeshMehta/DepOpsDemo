<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CoreWeb.SysXSecurityModel_UserControlFolderList" Codebehind="UserControlFolderList.aspx.cs" %>
...
<body>
    ...
    <infs:WclResourceManager ID="FolderListManager" runat="server">
        <infs:LinkedResource Path="~/Resources/Mod/IntsofSecurityModel/Scripts/UserControlFolderList.js"
