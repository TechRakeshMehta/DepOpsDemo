<%@ Control Language="C#" AutoEventWireup="true" Inherits="CoreWeb.ComplianceOperations.Views.ComplianceInstitutionHierarchy" Codebehind="ComplianceInstitutionHierarchy.ascx.cs" %>
