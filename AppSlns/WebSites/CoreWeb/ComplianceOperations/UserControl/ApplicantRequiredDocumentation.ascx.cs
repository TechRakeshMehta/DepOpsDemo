...
{
    public partial class ApplicantRequiredDocumentation : BaseUserControl, IApplicantRequiredDocumentationView
    {
        #region VARIABLES
        ...
        private ApplicantRequiredDocumentationPresenter _presenter = new ApplicantRequiredDocumentationPresenter();
        ...
        public ApplicantRequiredDocumentationPresenter Presenter
        {
            get
            {
        ...
        public IApplicantRequiredDocumentationView CurrentViewContext
        {
            get
            {
                return this;
        ...
        private bool CreateAndStoreESignature(SysDocumentFieldMappingContract documentInfo, List<SysDocumentFieldMappingContract> LstSpecialFields = null)
        {
            ...
            if (documentInfo.DocumentPath != null)
            {
                ...
                try
                {
                    ...
                    //byte[] documentContent = CommonFileManager.RetrieveDocument(documentInfo.DocumentPath, FileType.ApplicantFileLocation.GetStringValue());
        ...
        private Boolean UpdateDisclosurerPdfWithEsignature(byte[] pdfBytes, Boolean aWSUseS3, SysDocumentFieldMappingContract documentInfo)
        {
            ...
            try
            {
                ...
                if (_applicantOrderCart.IsNotNull())
                {
                    ...
                    //Added in UAT-4558
                    if (_applicantOrderCart.dicApplicantDocSysDocMapping.IsNullOrEmpty())
                        _applicantOrderCart.dicApplicantDocSysDocMapping = new Dictionary<Int32, Int32>();
                    if (!_applicantOrderCart.dicApplicantDocSysDocMapping.ContainsKey(documentInfo.ID))
                        _applicantOrderCart.dicApplicantDocSysDocMapping.Add(documentInfo.ID, documentInfo.SystemDocOldID.Value);
                    //END
                    ...
                    //if (_applicantOrderCart.lstSystemDocBkgSvcMapping.IsNullOrEmpty())
                    //    _applicantOrderCart.lstSystemDocBkgSvcMapping = new List<SystemDocBkgSvcMapping>();
                    //if (!documentInfo.SystemDocBkgSvcMapping.IsNullOrEmpty())
                    //    _applicantOrderCart.lstSystemDocBkgSvcMapping.Add(documentInfo.SystemDocBkgSvcMapping);
                    ////End
        ...
        /// </summary>
        public ApplicantRequiredDocumentation()
        {
