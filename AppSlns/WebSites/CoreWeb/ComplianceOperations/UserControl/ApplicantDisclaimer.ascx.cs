...
public partial class ComplianceOperations_UserControl_ApplicantDisclaimer : BaseUserControl, IApplicantDisclaimerView
{
    #region Variables

    #region Private Variables
    private ApplicantDisclaimerPresenter _presenter = new ApplicantDisclaimerPresenter();
    ...
    public ApplicantDisclaimerPresenter Presenter
    {
        get
        {
    ...
    public IApplicantDisclaimerView CurrentViewContext
    {
        get
        {
            return this;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //fsucCmdBar1.SubmitButton.ToolTip = "Agree to the Disclaimer and proceed to order confirmation";
        ...
        if (chkAccept.Checked && !hiddenOutput.Value.IsNullOrEmpty())
        {
            ...
            if (fsucCmdBar1.ClearButton.Value == AppConsts.PROCEED_BUTTON_TEXT || fsucCmdBar1.ClearButton.Value == AppConsts.NEXT_BUTTON_TEXT)
            {
                ...
                if (applicantOrderCart != null)
                {
                    ...
                    //SysXWebSiteUtils.SessionService.SetCustomData(AppConsts.DISCLAIMER_ACCEPTED, applicantOrderCart);
    ...
    protected void fsucCmdBar1_ExtraClick(object sender, EventArgs e)
    {
        ...
        if (CurrentViewContext.OrderType == OrderRequestType.NewOrder.GetStringValue())
        {
            ...
            else
            {
                ...
                //applicantOrderCart.AddOrderStageTrackID(OrderStages.ApplicantProfile); //UAT - 5184
                //applicantOrderCart.DecrementOrderStepCount(); //UAT - 5184
    ...
    private void SetButtonText()
    {
        ...
        else
        {
            if (this.IsAcceptanceClicked)
            {
                // fsucCmdBar1.ClearButton.Text = AppConsts.NEXT_BUTTON_TEXT;
    ...
    /// </summary>
    public ComplianceOperations_UserControl_ApplicantDisclaimer()
    {
