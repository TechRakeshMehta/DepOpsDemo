<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CoreWeb.ComplianceOperations.Views.PackageDetails" CodeBehind="PackageDetails.ascx.cs" %>
    ...
    <div class="content">
        <div class="sxform auto">
            <asp:Panel runat="server" CssClass="sxpnl" ID="pnlBeforeSubmission">
                        ...
                        <ItemTemplate>
                            <div class='sxro sx3co'>
                                ...
                                <div class='sxlm m2spn'>
                                    <asp:Label ID="lblBkgPackage" runat="server" CssClass="ronly" Text='<%# INTSOF.Utils.Extensions.HtmlEncode(Convert.ToString(Eval("BPAName"))) %>'>
                                    </asp:Label>
                                </div>
                                <div id="dvElement" runat="server" style="display: block;">
                                    <div class='sxlb'>
                            ...
                            <div class='sxro sx3co' id="dvAdditionalPrice" runat="server" visible="false">
                                <div>
                ...
                <infsu:OLI ID="OLI_PackageDetails" runat="server" />
                </div>
                ...
                <div id="dvTotalPrice" runat="server" style="display: block;">
