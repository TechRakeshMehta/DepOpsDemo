<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CoreWeb.ComplianceOperations.Views.VerificationDocumentPanel" CodeBehind="VerificationDocumentPanel.ascx.cs" %>
...
<asp:UpdatePanel runat="server" ID="updpnlDocument">
    <ContentTemplate>
        <div style="height: 100%">
            ...
            <infs:WclSplitter ID="sptrMain" runat="server" OnClientLoaded="SplitterLoaded" LiveResize="true" Orientation="Horizontal" ResizeWithParentPane="false"
                ...
                <infs:WclPane ID="WclPane1" runat="server" Height="55px">
                    <div class="framebar" title="Applicant's Documents">
                        ...
                        <div class="commands " style="float: left; padding-right: 10%;">
                            <div style="float: left; font-weight: bold; margin-right: 5px;">
                                <asp:Label ID="lblLabelViewType" runat="server" Text="View Type:"></asp:Label>
                            </div>
                        ...
                        <div class="commands">
                            <asp:LinkButton ID="lnkbtnShowAllDocuments" Text="View All" Visible="false" runat="server" OnClick="lnkbtnShowAllDocuments_Click"></asp:LinkButton>
                            &nbsp;<a onclick="openInPageFrame(this)" id="ancUpload" runat="server" visible="true">View All </a>&nbsp;
                            <asp:Label Text="Showing All Documents" runat="server" ID="lblShowingDocumentText"
                    ...
                    <telerik:RadRotator ID="RadRotator1" runat="server" AutoPostBack="false" FrameDuration="100"
                        ...
                        <ItemTemplate>
                            <div style="width: 80px; height: 70px; margin-right: 5px;" class='<%# DataBinder.Eval(Container.DataItem,"ApplicantDocumentId") %>'>
                                <div>
                                    <%--<asp:ImageButton ID="imgbtnDocuments" CommandName="cmd" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ApplicantDocumentId") %>'
...
<script type="text/javascript">
    ...
    function SplitterLoaded(splitter, arg) {
        $jQuery("[id$=updpnlDocument]").css("height", "100%");
    }
