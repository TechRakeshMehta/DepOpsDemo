...
{
    public partial class ExceptionAssignmentQueue : System.Web.UI.UserControl, IExceptionAssignmentQueueView
    {
        #region Privare Variables

        private ExceptionAssignmentQueuePresenter _presenter = new ExceptionAssignmentQueuePresenter();
        ...
        public ExceptionAssignmentQueuePresenter Presenter
        {
            get
            {
        ...
        /// <summary>
        /// Page_Load event
        /// Redirect to ExceptionDataVerificationQueue.ascx page
        /// </summary>
        ...
        public void GetUrl()
        {
            ...
            Dictionary<String, String>  queryString = new Dictionary<String, String>
                                                                 { 
                                                                    ...
                                                                    { "Child",@"~\ComplianceOperations\ExceptionDataVerificationQueue.ascx"},
                                                                    { "QCODE", queueCode}
                                                                 };
