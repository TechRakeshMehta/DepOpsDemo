...
{
    public partial class CountryIdentificationDetails : BaseWebPage
    {
        #region Private Variables

        private CountryIdentificationDetailsPresenter Presenter = new CountryIdentificationDetailsPresenter();
