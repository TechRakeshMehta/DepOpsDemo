<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackageBundle.aspx.cs" Inherits="CoreWeb.ComplianceAdministration.Views.PackageBundle" MasterPageFile="~/Shared/ChildPage.master" %>
        ...
        <div class="content">
            <div class="swrap">
                <infs:WclGrid runat="server" ID="grdPackageBundle" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    OnNeedDataSource="grdPackageBundle_NeedDataSource">
