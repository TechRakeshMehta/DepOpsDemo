...
{
    public partial class CustomAttributeProfileControl : BaseUserControl, ICustomAttributeControlView
    {
        #region Variables
        ...
        private void CreateDynamicControls()
        {
            ...
            Int64 _mappingId = CurrentViewContext.TypeCustomtAttribute.CAId;



            Boolean _isRequired = Convert.ToBoolean(CurrentViewContext.TypeCustomtAttribute.IsRequired);
            //UAT-1068
        ...
        private void ApplyRequiredField(Int64 mappingId, String controlId, String errorMessage)
        {
            ...
            divValidation.Controls.Add(rfValidator);
        }
        ...
        private void ApplyRegularExpressionValidator(Int64 mappingId, String controlId, String errorMessage, String regexPattern, String regexErrorMsg)
        {
            ...
            divValidation.Controls.Add(revValidator);
        }
