<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CoreWeb.ComplianceAdministration.Views.CustomAttributeControl" Codebehind="CustomAttributeControl.ascx.cs" %>
<asp:Panel ID="pnlControlsMode" runat="server" Visible="false">
    ...
    <div class='sxlm' id="divControlMode" runat="server">
    </div>
</asp:Panel>
...
<asp:Panel ID="pnlReadOnlyLabels" runat="server">
    ...
    <div class='sxlm'>
        <asp:Label ID="lblAttributeValueReadOnlyMode" CssClass="ronly" runat="server"></asp:Label></div>
</asp:Panel>
