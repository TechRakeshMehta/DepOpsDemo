...
{
	public partial class NewCustomAttributeRowControlSearch : BaseUserControl, ICustomAttributeRowControlSearchView
	{
        ...
        private void LoadAttributeControl()
        {
            ...
            {
                Control customAttribute = Page.LoadControl("~\\ComplianceAdministration\\UserControl\\NewCustomAttributeControlSearch.ascx");
                (customAttribute as NewCustomAttributeControlSearch).TypeCustomtAttribute = CurrentViewContext.lstTypeCustomAttributes[i];
                (customAttribute as NewCustomAttributeControlSearch).previousValues = CurrentViewContext.previousValues;
