<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminEntryApplicantInformation.ascx.cs" Inherits="CoreWeb.AdminEntryPortal.Views.AdminEntryApplicantInformation" %>
...
<script src="../../Resources/Mod/AdminEntryPortal/AdminEntryApplicantInformation.js"></script>
...
<asp:Panel ID="pnlMain" runat="server" Width="100%" Height="100%">
    <div class="section">
        ...
        <h1 class="mhdr"><%=Resources.Language.PERSONALINFO%></h1>
        <div class="content">
                ...
                <asp:Panel runat="server" CssClass="sxpnl" ID="pnlRegForm">
                    ...
                    <div class='sxro sx3co'>
                        ...
                        <div class='sxlm' id="dvSuffix" runat="server" style="display: none; width: 15%">
                            <infs:WclComboBox ID="cmbSuffix" Visible="false" runat="server" DataTextField="LAES_Suffix" DataValueField="LAES_ID"></infs:WclComboBox>
                    ...
                    <div class='sxro sx3co'>
                        ...
                        <div class='sxlm'>
                            ...
                            <div class="valdx">
                                <asp:RequiredFieldValidator runat="server" ID="rfvGender" ControlToValidate="cmbGender" ValidationGroup="grpFormSubmit"
                    ...
                    <%--<div class='sxro sx3co' id="divEditEmailNotifications" runat="server" style="display: none">
                        <div>
                    ...
                    <div class='sxro sx3co' id="dvBackgroundReport" runat="server" style="display: none">
                        <div class='sxlb'>
        ...
        <div class="cmdButtonMinSize">
            <div id="dvNextBtnStyleInSpanish" class="nextBtnStyleInSpanish">
                <infsu:CommandBar ID="fsucCmdBar1" runat="server" DisplayButtons="Clear" AutoPostbackButtons="Clear"
