<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminEntryWebCCF.ascx.cs" Inherits="CoreWeb.AdminEntryPortal.Views.AdminEntryWebCCF" %>
    ...
    <div class="content">
        <div class="sxform auto">
            <asp:Panel ID="pnlCapture" runat="server" DefaultButton="btnDrugScreenError">
                ...
                <div class="widgetbox">
                    <iframe id="MIS" width="1500" height="600" runat="server"></iframe>
                            ...
                            function loadParameters(password) {
                               // debugger;
                                var model = {
                                    ...
                                    ShowContinueButton: true, //Change button label
