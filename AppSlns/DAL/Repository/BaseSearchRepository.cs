...
namespace DAL.Repository
{
    ...
    /// </summary>
    public class BaseSearchRepository : IBaseRepository
    {
        #region Variables
        ...
        private ADBMessageDB_DevEntities _context;
        ...
        {
            _context = HttpContext.Current.IsNull() ? ADBMessageDB_DevEntities.GetAppContext() : ADBMessageDB_DevEntities.GetContext();
            Init();
        }
        ...
        public ADBMessageDB_DevEntities Context
        {
            get { return _context; }
        }
