...
{
    public class InvitationDetailDocViewerPresenter : Presenter<IInvitationDetailDocViewerView>
    {
        ...
        //    }
        //}
        public byte[] GetUnifiedPDFByteData(String unifiedDocumentPath)
        {
            if (!String.IsNullOrEmpty(unifiedDocumentPath))
            {
                //return DocumentManager.GetBytesFromUnifiedPdf(unifiedDocumentPath);\
                return DocumentManager.GetBytesFromLoyalSystem(unifiedDocumentPath);
            }
            return null;
        }
    }
