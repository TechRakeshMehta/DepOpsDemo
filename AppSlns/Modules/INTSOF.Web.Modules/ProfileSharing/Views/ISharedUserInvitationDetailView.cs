...
{
    public interface ISharedUserInvitationDetailView
    {
        ...
        //Int32 SharedOrganizationUserId { get; set; }
        RequirementPackageSubscription RequirementPackageSubscription { get; set; }
        #endregion

        Boolean IsIndividualShare { get; set; }
        Boolean IsNeedShowAllRotationInstructors { get; set; }
    }
}
