...
{
    public class CategoryDataReportPresenter : Presenter<ICategoryDataReportView>
    {
        ...
        public override void OnViewInitialized()
        {
            ...
            View.SavedSearches = DataMartManager.GetSavedSearches(View.UserID, SearchType.CategoryDataReport.GetStringValue());
        ...
        {
            SavedSearch savedSearch = DataMartManager.SaveCategoryDataSearchCriteria(View.SelectedSearch, View.UserID, View.SearchName, View.SearchDescription,
                   ...
                   View.RotationEndDate.HasValue ? View.RotationEndDate.Value.ToString() : String.Empty);
            View.SavedSearches = DataMartManager.GetSavedSearches(View.UserID, SearchType.CategoryDataReport.GetStringValue());
        ...
        public List<CategoryDataReportContract> GetCategoryDataReportContracts()
        {
            var returnData = DataMartManager.GetCategoryDataReportContracts(View.UserID, View.SelectedTenantIDs, View.SelectedAgencyIDs, View.SelectedCategories, View.SelectedItems
                , View.RotationStartDate, View.RotationEndDate, View.SelectedReviewStatus, View.SelectedUserType);
            return returnData != null ? returnData : new List<CategoryDataReportContract>();
        }
    }
}
