...
{
    public class AdminEntryApplicantInformationPresenter : Presenter<IAdminEntryApplicantInformationView>
    {
        #region Variables
        ...
        {
            View.OrganizationUser = AdminEntryPortalManager.GetOrganizationUser(View.TenantId, View.OrderID, View.CurrentLoggedInUserId);
        ...
        /// </summary>
        public Boolean SendVerificationCodeForEmailChange(String verificationCode, Entity.ClientEntity.OrganizationUser organizationUser, String newEmailAddress)
        {
            //Commented for Admin Enrty Portal
        ...
        public List<PreviousAddressContract> GetResidentialHistories(Int32 orgUserProfileId)
        {
            //Commented for Admin Entry Portal
            ...
            List<ResidentialHistoryProfile> tempResidentialAddress = SecurityManager.GetUserResidentialHistoryProfiles(orgUserProfileId).Where(cond => cond.RHIP_IsCurrentAddress != true).ToList();
            List<PreviousAddressContract> tempList = tempResidentialAddress.Where(cond => cond.Address.ZipCodeID > 0).Select(x => new PreviousAddressContract
            {
                ...
                ResHistorySeqOrdID = x.RHIP_SequenceOrder.IsNotNull() ? x.RHIP_SequenceOrder.Value : AppConsts.NONE,
