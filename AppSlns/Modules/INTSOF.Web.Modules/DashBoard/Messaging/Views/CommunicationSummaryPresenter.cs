...
namespace CoreWeb.Messaging.Views
{
    public class CommunicationSummaryPresenter : Presenter<ICommunicationSummaryView>
    {
        ...
        public void GetCommunicationSummary()
        {
            //Created By :Charanjot
            //new code for UAT-1427: WB: 
            ...
            else
            {
                ...
                try
                {
                    ...
                    List<CommunicationTemplateContract> lstCommunicationTemplate = CommunicationManager.GetCommunicationSummarysearch(searchItems, View.GridCustomPaging);
