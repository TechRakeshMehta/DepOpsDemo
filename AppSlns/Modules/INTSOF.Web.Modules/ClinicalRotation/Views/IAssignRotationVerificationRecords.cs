...
{
    public interface IAssignRotationVerificationRecords
    {
        ...
        //Int32 SelectedAgencyIDs { get; set; }
        ...
        List<Entity.OrganizationUser> lstOrganizationUser { set; }

        List<Int32> SelectedVerificationItems { set; get; }

        Int32 VerSelectedUserId { get; set; }
        String VerSelectedUserName { get; set; }
