...
{
    public class VerificationDetailsDocumentConrolPresenter : Presenter<IVerificationDetailsDocumentConrolView>
    {
        ...
        public void GetAllowedFileExtensions()
        {
            ...
            var lstAllowedFileExtensions = ComplianceDataManager.GetAllowedFileExtensionsByNodeIDs(View.SelectedTenantId_Global, selectedNodeIDs);
