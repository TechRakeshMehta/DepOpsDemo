...
{
    public class PackageDetailsPresenter : Presenter<IPackageDetailsView>
    {
        ...
        public void GetOrderBkgPackageDetails(List<Int32> bkgHierarchyMappingIds, Int32 ? SelectedHierachyId)
        {
            View.lstExternalPackages = BackgroundSetupManager.GetOrderBkgPackageDetails(View.TenantId, bkgHierarchyMappingIds, SelectedHierachyId);
        }
        #region UAT-3601
        ///<summary>
