...
{
    public interface IItemDataLoaderView
    {
        IItemDataLoaderView CurrentViewContext { get; }

        List<ApplicantItemVerificationData> lst { get; set; }
        Int32 CurrentLoggedInUserId { get; }
        Boolean IsDefaultTenant { get; set; }

        Boolean IsDeleteOverideStatusChecked { get; }
        ...
        List<ApplicantComplianceItemData> lstNotApprovedItems { get; set; }
        #endregion
