...
{
    public class ReconciliationDetailPresenter : Presenter<IReconciliationDetailView>
    {
        ...
        #region UAT-3744
        public List<DataReconciliationQueueContract> GetNextActiveReconciledItem(String selectedInstitutionIds, Int32 complianceItemReconciliationDataId)
        {
            return ComplianceDataManager.GetNextActiveReconciledItem(selectedInstitutionIds, complianceItemReconciliationDataId);
        }
