    ...
    public class BaseRepository : IBaseRepository
    {
        ...
        public BaseRepository()
        {
            ...
            _messagingContext = HttpContext.Current.IsNull() ?
                                 (ServiceContext.Current == null ?
                                        (ParallelTaskContext.Current.IsNull() ? ADBMessageDB_DevEntities.GetAppContext()
            ...
            _sharedDataDBContext = HttpContext.Current.IsNull() ?
                                    (ServiceContext.Current == null ?
                                           (ParallelTaskContext.Current.IsNull() ? ADBSharedDataEntity.GetAppContext()
            ...
            _locationDBContext = HttpContext.Current.IsNull() ?
                                    (ServiceContext.Current == null ?
                                           (ParallelTaskContext.Current.IsNull() ? ADBLocationDataEntities.GetAppContext()
